...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'joint_slider_gui = so101_hw_interface.joint_slider_gui:main',
            'trajectory_bridge = so101_hw_interface.trajectory_bridge:main',
            'moveit_panel = so101_hw_interface.moveit_panel:main',
        ],
    },
) 